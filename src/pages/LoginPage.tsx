...
export default function LoginPage() {
  ...
  const handleOAuth = async (provider: 'google' | 'apple' | 'discord') => {
    ...
    const result = actions.loginWithOAuth(provider);
    if (!result.success) {
        ...
        >
          ...
          <div className="space-y-2.5 mb-6">
            <motion.button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white/5 hover:bg-white/10 rounded-xl text-white font-medium transition-all border border-white/10 hover:border-white/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <motion.button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#5865F2]/10 hover:bg-[#5865F2]/20 rounded-xl text-white font-medium transition-all border border-[#5865F2]/30 hover:border-[#5865F2]/50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="space-y-3">
            ...
            <motion.button
              ...
              disabled={loading}
              className="w-full py-3.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-xl text-white font-bold transition-all shadow-lg shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed mt-4"
            >
              {loading ? (
